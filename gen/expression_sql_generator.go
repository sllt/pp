...
type (
	...
	ExpressionSQLGenerator interface {
		Dialect() string
		Generate(b builder.SQLBuilder, val interface{})
	}
...
func (esg *expressionSQLGenerator) Generate(b builder.SQLBuilder, val interface{}) {
	if b.Error() != nil {
		return
	}
	if val == nil {
...
func (esg *expressionSQLGenerator) reflectSQL(b builder.SQLBuilder, val interface{}) {
...
func (esg *expressionSQLGenerator) expressionSQL(b builder.SQLBuilder, expression exp.Expression) {
...
func (esg *expressionSQLGenerator) placeHolderSQL(b builder.SQLBuilder, i interface{}) {
...
func (esg *expressionSQLGenerator) appendableExpressionSQL(b builder.SQLBuilder, a exp.AppendableExpression) {
...
func (esg *expressionSQLGenerator) identifierExpressionSQL(b builder.SQLBuilder, ident exp.IdentifierExpression) {
	if ident.IsEmpty() {
...
func (esg *expressionSQLGenerator) lateralExpressionSQL(b builder.SQLBuilder, le exp.LateralExpression) {
...
func (esg *expressionSQLGenerator) literalNil(b builder.SQLBuilder) {
	if b.IsPrepared() {
...
func (esg *expressionSQLGenerator) literalBool(b builder.SQLBuilder, bl bool) {
	if b.IsPrepared() {
...
func (esg *expressionSQLGenerator) literalTime(b builder.SQLBuilder, t time.Time) {
	if b.IsPrepared() {
...
func (esg *expressionSQLGenerator) literalFloat(b builder.SQLBuilder, f float64) {
	if b.IsPrepared() {
...
func (esg *expressionSQLGenerator) literalInt(b builder.SQLBuilder, i int64) {
	if b.IsPrepared() {
...
func (esg *expressionSQLGenerator) literalString(b builder.SQLBuilder, s string) {
	if b.IsPrepared() {
...
func (esg *expressionSQLGenerator) literalBytes(b builder.SQLBuilder, bs []byte) {
	if b.IsPrepared() {
...
func (esg *expressionSQLGenerator) sliceValueSQL(b builder.SQLBuilder, slice reflect.Value) {
	b.WriteRunes(esg.dialectOptions.LeftParenRune)
...
func (esg *expressionSQLGenerator) aliasedExpressionSQL(b builder.SQLBuilder, aliased exp.AliasedExpression) {
...
func (esg *expressionSQLGenerator) booleanExpressionSQL(b builder.SQLBuilder, operator exp.BooleanExpression) {
	b.WriteRunes(esg.dialectOptions.LeftParenRune)
...
func (esg *expressionSQLGenerator) bitwiseExpressionSQL(b builder.SQLBuilder, operator exp.BitwiseExpression) {
	b.WriteRunes(esg.dialectOptions.LeftParenRune)
...
func (esg *expressionSQLGenerator) rangeExpressionSQL(b builder.SQLBuilder, operator exp.RangeExpression) {
	b.WriteRunes(esg.dialectOptions.LeftParenRune)
	esg.Generate(b, operator.LHS())
	b.WriteRunes(esg.dialectOptions.SpaceRune)
	operatorOp := operator.Op()
...
func (esg *expressionSQLGenerator) orderedExpressionSQL(b builder.SQLBuilder, order exp.OrderedExpression) {
...
func (esg *expressionSQLGenerator) expressionListSQL(b builder.SQLBuilder, expressionList exp.ExpressionList) {
...
func (esg *expressionSQLGenerator) columnListSQL(b builder.SQLBuilder, columnList exp.ColumnListExpression) {
...
func (esg *expressionSQLGenerator) updateExpressionSQL(b builder.SQLBuilder, update exp.UpdateExpression) {
...
func (esg *expressionSQLGenerator) sqlWindowFunctionExpression(b builder.SQLBuilder, sqlWinFunc exp.SQLWindowFunctionExpression) {
...
func (esg *expressionSQLGenerator) windowExpressionSQL(b builder.SQLBuilder, we exp.WindowExpression) {
	if !esg.dialectOptions.SupportsWindowFunction {
		b.SetError(ErrWindowNotSupported(esg.dialect))
		return
	}
...
func (esg *expressionSQLGenerator) commonTablesSliceSQL(b builder.SQLBuilder, ctes []exp.CommonTableExpression) {
	l := len(ctes)
	if l == 0 {
		return
	}
...
func (esg *expressionSQLGenerator) commonTableExpressionSQL(b builder.SQLBuilder, cte exp.CommonTableExpression) {
...
func (esg *expressionSQLGenerator) compoundExpressionSQL(b builder.SQLBuilder, compound exp.CompoundExpression) {
...
func (esg *expressionSQLGenerator) caseExpressionSQL(b builder.SQLBuilder, caseExpression exp.CaseExpression) {
...
func (esg *expressionSQLGenerator) expressionMapSQL(b builder.SQLBuilder, ex exp.Ex) {
...
func (esg *expressionSQLGenerator) expressionOrMapSQL(b builder.SQLBuilder, ex exp.ExOr) {
	expressionList, err := ex.ToExpressions()
	if err != nil {
		b.SetError(err)
		return
