...
type (
	CommonSQLGenerator interface {
		...
		ReturningSQL(b builder.SQLBuilder, returns exp.ColumnListExpression)
		FromSQL(b builder.SQLBuilder, from exp.ColumnListExpression)
		SourcesSQL(b builder.SQLBuilder, from exp.ColumnListExpression)
		WhereSQL(b builder.SQLBuilder, where exp.ExpressionList)
		OrderSQL(b builder.SQLBuilder, order exp.ColumnListExpression)
		OrderWithOffsetFetchSQL(b builder.SQLBuilder, order exp.ColumnListExpression, offset uint, limit interface{})
		LimitSQL(b builder.SQLBuilder, limit interface{})
		UpdateExpressionSQL(b builder.SQLBuilder, updates ...exp.UpdateExpression)
	}
...
func (csg *commonSQLGenerator) ReturningSQL(b builder.SQLBuilder, returns exp.ColumnListExpression) {
...
func (csg *commonSQLGenerator) FromSQL(b builder.SQLBuilder, from exp.ColumnListExpression) {
...
func (csg *commonSQLGenerator) SourcesSQL(b builder.SQLBuilder, from exp.ColumnListExpression) {
	b.WriteRunes(csg.dialectOptions.SpaceRune)
	csg.esg.Generate(b, from)
}

// Generates the WHERE clause for an SQL statement
func (csg *commonSQLGenerator) WhereSQL(b builder.SQLBuilder, where exp.ExpressionList) {
...
func (csg *commonSQLGenerator) OrderSQL(b builder.SQLBuilder, order exp.ColumnListExpression) {
...
func (csg *commonSQLGenerator) LimitSQL(b builder.SQLBuilder, limit interface{}) {
	if limit != nil {
...
func (csg *commonSQLGenerator) UpdateExpressionSQL(b builder.SQLBuilder, updates ...exp.UpdateExpression) {
	if len(updates) == 0 {
