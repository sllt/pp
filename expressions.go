...
//    ds.Join(pp.T("my_table"), pp.On(
//       pp.I("my_table.fkey").Eq(pp.I("other_table.id")),
//    ))
...
//    ds.Join(pp.T("my_table"), pp.Using("fkey"))
...
// Create a new SQL value ( alias for pp.L("?", val) ). The prrimary use case for this would be in selects.
// See examples.
