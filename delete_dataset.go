...
func (dd *DeleteDataset) AppendSQL(b builder.SQLBuilder) {
	if dd.err != nil {
		b.SetError(dd.err)
		return
	}
...
func (dd *DeleteDataset) deleteSQLBuilder() builder.SQLBuilder {
	buf := builder.NewSQLBuilder(dd.isPrepared.Bool())
	if dd.err != nil {
