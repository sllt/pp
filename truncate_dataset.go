...
func (td *TruncateDataset) Build() (sql string, params []interface{}, err error) {
	return td.truncateSQLBuilder().Build()
}
...
func (td *TruncateDataset) truncateSQLBuilder() builder.SQLBuilder {
	buf := builder.NewSQLBuilder(td.isPrepared.Bool())
	if td.err != nil {
